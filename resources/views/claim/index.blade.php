...
<div class="min-h-screen bg-gray-50 pb-24">
    ...
    <div class="bg-gradient-to-r from-[#0c3e2b] via-[#0f4d36] to-[#072419] text-white shadow-md relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative z-10">
            <h1 class="text-2xl md:text-3xl font-extrabold tracking-tight">Status Klaim Saya</h1>
            <p class="text-sm text-emerald-100/90 mt-1">Pantau proses verifikasi dan pengambilan barang yang telah Anda klaim.</p>
        </div>
    </div>
